...
export default async function GrowthAdminPage() {
  ...
  return <main className="growth">
    ...
    <nav className="growthTabs"><Link className="active" href="/admin/growth">Overview</Link><a href="#social-intelligence">Social</a><a href="#hosts">Hosts</a><Link href="/admin/growth/content">Content</Link><Link href="/admin/growth/queue">Prompt Packs</Link><Link href="/admin/growth/threads">Threads</Link></nav>
    <CampaignBuilder/>
    <GrowthSocialIntel/>
    <GrowthHosts/>
