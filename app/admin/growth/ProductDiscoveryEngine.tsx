...
type Product={id?:string;product_id?:string;title?:string;brand?:string;price?:number;currency?:string;image?:string;image_url?:string;url?:string;source?:string;supplierPrice?:number;supplierOfferCount?:number;supplierOffers?:any[];description?:string;tags?:string[];advertability_score?:number;[key:string]:any};

function number(v:any){const n=Number(v);return Number.isFinite(n)?n:0}
