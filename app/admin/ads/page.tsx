...
export default function AdFactoryPage(){
 ...
 return <main className={styles.shell}><div className={styles.wrap}>
  ...
  <section className={styles.grid4}>
   <div className={styles.metric}><b>{overview?.niches.total||0}</b><span>Niches</span></div><div className={styles.metric}><b>{overview?.creatives.total||0}</b><span>Creatives</span></div><div className={styles.metric}><b>{overview?.jobs.queued||0}</b><span>Queued renders</span></div><div className={styles.metric}><b>{overview?.campaigns.active||0}</b><span>Live campaigns</span></div>
  </section>
  ...
  <div className={styles.layout}>
   ...
   <aside className={styles.panel}><h2>Creative brief</h2><div className={styles.muted}>This is the first controlled-generation layer. Each draft keeps the exact product IDs and creative lineage.</div>
