...
import {generateGeminiAdVariants,geminiGrowthImageConfigured} from "@/lib/creators/gemini-growth-image";
...
async function saveCreative(input:{ad:any;product:any;analysis:any;direction:any;variants:any[];scores:any[];folderId?:string}){
 ...
 const provider="gemini-nano-banana-2-lite";
