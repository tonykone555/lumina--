...
export async function POST(req:NextRequest){
 try{
  ...
  try{
    const result=await renderStudioVideo({mode,productTitle:title,productImageUrl:image,sourceVideoUrl:sourceVideoUrl||undefined,avatarImageUrl:avatarImageUrl||undefined,backgroundImageUrl:backgroundImageUrl||undefined,angle});
