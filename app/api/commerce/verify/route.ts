...
import {checkoutMode,pricedCheckout,revalidateProduct,resolveShipping,type CheckoutProduct,type Region} from "@/lib/commerce/checkout";
...
export async function POST(req:NextRequest){
 try{
  ...
  const shipping=await resolveShipping(product,body.region);
