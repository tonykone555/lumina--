...
revoke all on function public.ynot_claim_referrer(uuid,text) from public,anon,authenticated;
revoke all on function public.ynot_available_credit(uuid) from public,anon,authenticated;
revoke all on function public.ynot_reserve_credit(uuid,text,integer) from public,anon,authenticated;
revoke all on function public.ynot_release_credit(text) from public,anon,authenticated;
revoke all on function public.ynot_release_expired_reservations() from public,anon,authenticated;
revoke all on function public.ynot_settle_order(uuid,text,integer,integer,text) from public,anon,authenticated;
revoke all on function public.ynot_reverse_order(text) from public,anon,authenticated;
grant execute on function public.ynot_claim_referrer(uuid,text) to service_role;
grant execute on function public.ynot_available_credit(uuid) to service_role;
grant execute on function public.ynot_reserve_credit(uuid,text,integer) to service_role;
grant execute on function public.ynot_release_credit(text) to service_role;
grant execute on function public.ynot_release_expired_reservations() to service_role;
grant execute on function public.ynot_settle_order(uuid,text,integer,integer,text) to service_role;
grant execute on function public.ynot_reverse_order(text) to service_role;
