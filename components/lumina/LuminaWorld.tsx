...
export default function LuminaWorld(){
 ...
 function closeProduct(){
  const cameFromDeepLink=Boolean(deepProductRef.current);
  setSelected(null);setSuggestionsOpen(false);setCheckoutError("");setHovered(null);
  if(cameFromDeepLink){
   centerWorld(window.innerWidth>=900?1.08:.98);
   window.requestAnimationFrame(()=>window.dispatchEvent(new Event("ynot:world-focus")));
   try{
