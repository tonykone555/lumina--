...
type PartnerLead={username:string;displayName?:string;profileUrl?:string;avatar?:string;followers?:number;engagementRate?:number;email?:string;category?:string;shopUrl?:string;source?:string};
