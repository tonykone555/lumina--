...
export default function EtsyCatalogBridge(){
 useEffect(()=>{
  ...
  window.fetch=(async(input:RequestInfo|URL,init?:RequestInit)=>{
   ...
   const normalized={source:"etsy-marketplace",sources:["etsy-marketplace"],market:"lumina",luminaSource:"shopify",products,pagination:{has_next_page:products.length>=24,next_cursor:null},error:products.length?undefined:"No Etsy products found for this search yet."};
