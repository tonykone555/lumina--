...
useEffect(()=>{
 ...
 const run=()=>{
  ...
  if(input&&button){initialSearchRan.current=true;setBottomQuery(cleanInitial);setReactInput(input,cleanInitial);window.dispatchEvent(new CustomEvent("shop:tag-search",{detail:{query:cleanInitial,tags:[]}}));requestAnimationFrame(()=>button.click());return}
